          ...
          <div className="flex-1 text-center">
            ...
            >
              ...
              <div className="flex flex-row gap-4 justify-center">
                <button className="sm:px-8 px-12 sm:py-4 py-2 bg-gradient-to-l from-[#ff8c93] to-[#e51245] text-black 
                ...
                <button className="px-8 sm:py-4 py-3 glass-card bg-black/50
