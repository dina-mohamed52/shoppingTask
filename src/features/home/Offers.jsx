    ...
    >
      ...
      <div className="relative mb-12 flex justify-center">
        ...
        <div className="relative bg-gradient-to-r from-gray-900 to-gray-800 px-8 py-4 rounded-full border border-pink-500/30 shadow-2xl flex items-center gap-3">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-pink-400 via-pink-300 to-white">
            {t("offers.title")}
          </h2>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <div className={`w-10 h-10 rounded-full bg-gradient-to-br from-pink-500/20 to-pink-600/20 flex items-center justify-center border border-pink-500/30 ${
                      isHovered ? "animate-pulse" : ""
                    }`}>
                      <Gift className={`w-5 h-5 ${offer.textColor || "text-pink-400"}`} />
                    </div>
                    <span className={`text-lg sm:text-xl font-semibold ${offer.textColor || "text-gray-200"}`}>
                      {offer.quantity}
                    </span>
                  </div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className={`text-2xl sm:text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r ${
